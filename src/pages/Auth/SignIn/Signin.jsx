...
const Signin = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-br from-[#EEF7D6] to-[#D2EA93] px-6">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center text-center bg-white p-8 md:p-12">
        {step === "signin" ? (
          <>
            <h2 className="text-3xl font-bold text-black">Sign In to your Zooby Account</h2>
  ...
  <div className="flex-1 h-px bg-gradient-to-l from-transparent via-gray-300 to-gray-300"></div>
            ...
            <h3 className="text-lg font-semibold text-gray-700">Sign In with your Email / Mobile Number</h3>
            <input
              type="text"
            ...
            <GetStartedButton handleClick={handleSubmit} inputValue={inputValue}  />

            

            <p className="mt-4 text-gray-600">
              Already have an account? <a href="/signup" className="text-[#526426] font-semibold">Sign Up</a>
            </p>
          </>
        ) : step === "emailOtp" ? (
